...
if(vez==1){
document.getElementById("img"+casa).src="img/leaovelha.png"; //se o jogador for -1, coloca o desenho da bola
}else{
document.getElementById("img"+casa).src="img/elefantevelha.png";
} 
...
function confere() {
    ...
    if(Soma [i]==-3){
    lGanhou= true;
    sResposta = "Elefante GANHOU";
    iPontosO++;
    document.getElementById("bola").innerHTML ="ELEFANTE: " + iPontosO;
    break;

    //se achou uma soma (3) é porque o xis ganhou
    }else if(Soma[i] == 3){
        lGanhou = true;
        sResposta = "Leão GANHOU";
        iPontosX++;
    document.getElementById("xis").innerHTML = "LEÃO: " + iPontosX;
    }
}
